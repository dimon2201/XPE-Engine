...
#define AUDIO_STOPPED AL_STOPPED
#define AUDIO_PLAYING AL_PLAYING
#define AUDIO_PAUSED  AL_PAUSED
#define AUDIO_INITIAL AL_INITIAL
...
namespace xpe {
	...
	namespace audio {
		...
		namespace context {
			...
			inline ALCcontext* OpenALContext = nullptr;
			inline ALCdevice* PlaybackDevice = nullptr;
			inline ALCdevice* RecordDevice = nullptr; 
			...
			u32 ENGINE_API GetFormat(const AudioFile& file, u32 channels);
