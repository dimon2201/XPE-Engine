...
namespace xpe {
    ...
    namespace math {
        ...
        glm::mat4 cMathManager::UpdateDirectLightMatrix(const sOrthoMatrix& orthoMatrix, const sViewMatrix& viewMatrix) {
            return UpdateOrthoMatrix(orthoMatrix) * UpdateViewMatrix(viewMatrix);
        }

        glm::mat4 cMathManager::UpdateDirectLightMatrix(const sPerspectiveMatrix& perspectiveMatrix, const sViewMatrix& viewMatrix) {
