namespace xpe {
    ...
    namespace core {
        ...
        MemoryPoolStack* Memory::MainPools = nullptr;
        MemoryPoolStack* Memory::HotPools = nullptr;

        void Memory::Init() {
            // use by default 15% of TOTAL PHYSICAL RAM for main pre-allocation
            usize mainMemorySize = Hardware::Memory.TotalPhysical * 0.15;
