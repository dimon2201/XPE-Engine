namespace xpe {
    ...
    namespace core {
        ...
        TaskDispatcher* Threading::s_Dispatcher = nullptr;
        ...
        void Threading::Init(TaskDispatcher* dispatcher)
        {
        ...
        void Threading::SubmitTask(const Task &task)
        {
            s_Dispatcher->Dispatch(task);
        }

        void Threading::SubmitTask(u32 tasksPerThread, u32 totalTasks, const Task &task)
        {
