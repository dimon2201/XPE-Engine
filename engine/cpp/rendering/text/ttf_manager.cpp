...
xpe::render::Context* xpe::text::TTFManager::s_Context = nullptr;
xpe::core::Boolean xpe::text::TTFManager::s_Loaded = core::K_FALSE;
FT_Library xpe::text::TTFManager::s_Lib;
xpe::core::unordered_map<std::string, xpe::text::Font>* xpe::text::TTFManager::s_Fonts = nullptr;

void xpe::text::TTFManager::Init(render::Context* context) {
    s_Context = context;
    s_Fonts = new xpe::core::unordered_map<std::string, xpe::text::Font>();
}

void xpe::text::TTFManager::Free() {
    FT_Done_FreeType(s_Lib);
    delete s_Fonts;
}

xpe::text::Font xpe::text::TTFManager::Load(const std::string& filePath, core::usize glyphSize)
{
    Font font = {};
...
xpe::text::Font* xpe::text::TTFManager::Resize(const std::string& filePath, core::usize glyphSize)
{
...
void xpe::text::TTFManager::Free(Font& font)
{
    render::TextureManager::FreeTexture(font.Atlas);
...
xpe::text::Font* xpe::text::TTFManager::GetFont(const std::string& filePath)
{
