...
namespace xpe {
    ...
    namespace render {
        ...
        void ShaderManager::Init() {
            ...
            FileSystem::CreateDir("generated/shaders");
            FileSystem::CreateDir("generated/engine_shaders");
            FileSystem::CreateDir("generated/engine_shaders/passes");
        ...
        void ShaderManager::AddVertexStageFromFile(Shader* const shader, const char *filepath) {
            ...
            string src = FileSystem::ReadFileWithIncludes(filepath, "#include");
        ...
        void ShaderManager::WriteGeneratedShader(const char *filepath, const string &src) {
            ...
            FileSystem::WriteFile(generatedFilepath.c_str(), src);
        }
