    ...
    namespace render
    {
        namespace context
        {
            ...
            void Init()
            {
                ...
                CreateSwapchain(MWindow::GetWidth(), MWindow::GetHeight());
            ...
            void CreateSwapchain(int width, int height)
            {
                ...
                s_GIModeDesc.RefreshRate.Numerator = MWindow::GetRefreshRate();
                ...
                swapChainDesc.OutputWindow = (HWND)MWindow::GetWin32Instance();
                swapChainDesc.Windowed = MWindow::IsWindowed();
                swapChainDesc.SwapEffect = DXGI_SWAP_EFFECT_DISCARD;

                s_GIFactory->CreateSwapChain(s_Device, &swapChainDesc, &s_SwapChain);
                LogDebugMessage();

                s_SwapChain->SetFullscreenState(MWindow::IsFullscreen(), nullptr);
            ...
            void CompileShaderStage(cShaderStage &stage)
            {
            ...
            void CreateShaderStage(cShaderStage &stage)
            {
            ...
            void VSBindStage(const cShaderStage &stage)
            {
            ...
            void PSBindStage(const cShaderStage &stage)
            {
            ...
            void GSBindStage(const cShaderStage &stage)
            {
            ...
            void CSBindStage(const cShaderStage &stage)
            {
            ...
            void VSUnbindStage(const cShaderStage &stage)
            {
                for (auto* buffer : stage.Buffers)
                {
            ...
            void PSUnbindStage(const cShaderStage &stage)
            {
                for (auto* buffer : stage.Buffers)
                {
            ...
            void GSUnbindStage(const cShaderStage &stage)
            {
                for (auto* buffer : stage.Buffers)
                {
            ...
            void CSUnbindStage(const cShaderStage &stage)
            {
                for (auto* buffer : stage.Buffers)
                {
            ...
            void FreeShaderStage(cShaderStage &stage)
            {
            ...
            void CreateTexture1D(cTexture &texture)
            {
                ...
                else if (texture.ViewType == cTexture::eViewType::UAV)
                {
            ...
            void CreateSampler(cSampler& sampler)
            {
            ...
            void FreeSampler(cSampler& sampler)
            {
