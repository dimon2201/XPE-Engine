    ...
    namespace core
    {
        class D3D11RenderingContext : public RenderingContext_Interface
        {
            public:
                ...
                void CreateShaderFromString(xShader& shader, const xShader::PrimitiveTopology& topology, const xShader::Type& type, const char* str, const char* funcName, const char* profile, const uword flags) override final;
                ...
                void BindTexture(const GPUResource* texture, const xShader::Type& shaderType, const u32 slot) override final;
