namespace xpe
{
    namespace core
    {
        ...
        void MLog::Init(const sLoggerDescriptor& descriptor)
        {
        ...
        void MLog::DumpBacktrace()
        {
            s_Tracer->dump_backtrace();
        }

        spdlog::logger* MLog::GetLogger()
        {
            return s_Logger.get();
        }

        spdlog::logger* MLog::GetTracer()
        {
            return s_Tracer.get();
        }

        spdlog::logger* MLog::GetMemLogger()
        {
